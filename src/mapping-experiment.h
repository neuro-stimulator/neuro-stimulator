...
typedef struct experiment_rea_head_s {
    ...
    experiment_output_brightness_t brightness;                                                // 1 byte
} experiment_rea_head_t;
#pragma pack(pop)

#pragma pack(push, 1)
typedef struct experiment_rea_output_s {
} experiment_rea_output_t;
#pragma pack(pop)

#pragma pack(push, 1)
typedef struct experiment_rea_s {
    experiment_rea_head_t head;
    experiment_rea_output_t outputs;
} experiment_rea_t;
#pragma pack(pop)
...
union ExperimentConfig {
    uint8_t type;                                                      // 1 byte
    experiment_erp_t  experimentERP;                                   //
    ...
    experiment_rea_t  experimentREA;
};

union OutputConfig {
    experiment_erp_outputs_t    outputERP;
